...
public class TaskDAOFactory {
  ...
  public static Task getTasksFromFactory(User user, int idtasks, LocalDate dateCreate, LocalDate dateModified,String header,String description,boolean report,boolean recycle_Bin){
    return new Task()
        .setUser(user)
        .setIdtasks(idtasks)
